...
public class HttpInvokerServer implements HttpRequestHandler {
	...
	public void handleRequest(HttpServletRequest request, HttpServletResponse response)
		...
		ThreadLocal<Object> scopeHolder = Tracing.isEnabled() ? new ThreadLocal<Object>() : null;
	...
	protected RemoteInvocationResult createRemoteInvocationResult(HttpServletRequest request,
		...
		if (value instanceof Optional) {
			...
			try (Scope scope = Tracing.isEnabled() ? GlobalTracer.get().buildSpan("async").startActive(false)
					: null) {
